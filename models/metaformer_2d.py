...
class MetaFormer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        for i in range(self.num_stage):
            ...
            # print('shape:', intmd_output[i].shape)
...
def caformer_s18(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict =  torch.load('/data/sd0809/Pretrain_Weight/caformer_s18.pth', map_location="cpu")
        try:
            model.load_state_dict(state_dict)
...
def caformer_s18_384(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict =  torch.load('/data/sd0809/Pretrain_Weight/caformer_s18_384.pth', map_location="cpu")
        try:
            model.load_state_dict(state_dict)
        except RuntimeError as e:
            print('Ignoring "' + str(e) + '"')
